...
- (void)addTopView {
    ...
    self.topView = [[UIImageView alloc] initWithFrame:CGRectMake(0.f, 0.f, CGRectGetWidth(self.bounds), CGRectGetMidY(self.bounds))];
    ...
    self.backView.image = [self blurredImageWithImage:image];
